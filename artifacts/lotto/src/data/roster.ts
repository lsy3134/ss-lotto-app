...
export const ROSTER: PersonData[] = [
  ...
  { no: 4,  name: "유지현", cart: 2,  group: "하우스", 조: 1 },
  ...
  { no: 42, name: "이예지", cart: 15, group: "하우스", 조: 3 },
  { no: 43, name: "정  온", cart: 7,  group: "하우스", 조: 3 },
  ...
  { no: 52, name: "유라",   cart: 60, group: "하우스", 조: 4 },
  { no: 53, name: "박민지", cart: 12, group: "하우스", 조: 4 },
  { no: 54, name: "성지영", cart: 3,  group: "하우스", 조: 4 },
  { no: 55, name: "서예진", cart: 19, group: "하우스", 조: 4 },
  ...
  { no: 81, name: "홍다혜", cart: 27, group: "주말", 조: 3 },
  { no: 82, name: "박혜진", cart: 29, group: "주말", 조: 3 },
  { no: 85, name: "이지혜", cart: undefined, group: "주말", 조: 4 },
